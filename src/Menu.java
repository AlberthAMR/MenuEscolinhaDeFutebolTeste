...
public class Menu {
    public static void main(String[] args) {
        int opcao;
        String nomeAluno, dataNascimento, posicao, telefone, cpf, email;
        ...
        do {
            ...
            scanner.nextLine();
            // Se o usuário escolher a opção 1, o programa irá solicitar os dados do aluno.
            // Se o usuário escolher a opção 2, o programa irá listar todos os alunos cadastrados.
            // Se o usuário escolher a opção 3, o programa irá buscar um aluno pelo nome.
            // Se o usuário escolher a opção 4, o programa irá editar os dados de um aluno.
            // Se o usuário escolher a opção 5, o programa irá excluir um aluno.
            // Se o usuário escolher a opção 6, o programa irá sair do menu.
            if (opcao == 1) {
                ...
                Aluno novoAluno = new Aluno(nomeAluno, dataNascimento, posicao, telefone, cpf, email);
